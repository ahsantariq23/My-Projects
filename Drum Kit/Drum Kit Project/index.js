...
document.querySelectorAll(".drum")[i].addEventListener("click" , function(){
    ...
    let buttonDetector=this.innerHTML;
 makeSound(buttonDetector);

 addAnimation(buttonDetector);
...
function addAnimation(pressedKey){
   ...
   setTimeout(remover,100); //high order function
